package pl.javaproject.labmaster_02.dto;
...
public class UserDto {
    ...
    public UserDto(String nazwisko, String imie, String email, String telefon, String stanowisko, String departament, String pensja, String konto_zatwierdzone) {
        Nazwisko = nazwisko;
        Imie = imie;
        Email = email;
        Telefon = telefon;
